...
DESCRIPTION="Logical Replication extension for PostgreSQL 9.4, 9.5, 9.6 and 10, providing fast replication, as well as cross-version upgrades."
...
DEPEND="|| (
		...
		dev-db/postgresql:10=[server,static-libs]
	)"
RDEPEND="${DEPEND}"
